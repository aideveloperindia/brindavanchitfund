              ...
              {chairman ? (
                <div className='space-y-6'>
                  ...
                  <div className='premium-card border border-slate-200/80 bg-white/90 p-8 text-center backdrop-blur hover-lift'>
                    <div className='mx-auto mb-6 flex h-28 w-28 items-center justify-center rounded-full bg-gradient-to-br from-[#0F2747] to-[#245C8E] shadow-2xl'>
                    ...
                    <p className='text-lg font-bold text-[#D9A441]'>
