...
export default function ChitsPage() {
  ...
  return (
    <div className='w-full min-h-screen bg-gradient-to-b from-gray-50 to-white'>
      ...
      {/* Premium Header */}
      <section className='pt-32 pb-16 px-6 bg-gradient-to-br from-[#0F2747] to-[#245C8E] text-white relative overflow-hidden'>
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-4">
            {language === 'te' 
              ? 'ప్రతి కుటుంబానికి, ప్రతి వ్యాపారానికి సరిపోయే భద్రమైన, పారదర్శకమైన చిట్టీలు'
              : 'Safe, transparent and flexible chit groups designed for every family and every business'
            }
          </p>
        </div>
      </section>
      ...
      <div className='py-16 px-6'>
        <div className="max-w-7xl mx-auto">
          {/* Intro Paragraph */}
          <div className="premium-card p-8 mb-12 text-center">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
              {language === 'te' 
                ? 'బ్రిందావన్ చిట్స్‌లో ₹50,000 నుంచి ₹20,00,000 వరకు వివిధ రకాల చిట్టీలు లభ్యం. ప్రతి చిట్టి పూర్తిగా పారదర్శకంగా, సమయానికి వేలం జరుగుతుంది. మీ అవసరానికి సరిపోయే చిట్టిని ఎంచుకోండి — చిన్నకాలం, దీర్ఘకాలం, నెలవారీ లేదా వారాంతం.'
                : 'Brindavan Chits offers professionally-managed chit schemes ranging from ₹50,000 to ₹20,00,000. Every chit is operated with complete transparency, timely auctions, and clear communications. Choose a chit that matches your financial goals — short-term, long-term, monthly or weekly.'
              }
            </p>
          </div>
          ...
          <div className="premium-card p-8 mb-12">
            <h2 className="text-2xl font-black text-[#0F2747] mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-5 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0F2747] focus:border-[#0F2747] transition-all font-semibold"
                >
            ...
            {filteredChits.map((chit, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  {chit.status === 'active' && (
                    <span className="px-4 py-2 bg-gradient-to-r from-sky-100 to-sky-200 text-sky-800 rounded-full text-xs font-black whitespace-nowrap shadow-md">
                ...
                <Link
                  ...
                  className="block w-full text-center bg-gradient-to-r from-[#0F2747] to-[#245C8E] text-white py-4 rounded-xl hover:from-[#245C8E] hover:to-[#0F2747] transition-all duration-300 font-black text-lg shadow-lg hover:shadow-xl transform hover:scale-105 min-h-[56px] flex items-center justify-center"
                >
                  {t.chits.viewDetails}
                </Link>
              </div>
